...
import { getMetadataFiltersValues } from '../n8n-utils/utils';
import { VectorStoreNodeConstructorArgs } from '../n8n-utils/vector_store/types';
...
export async function handleRetrieveAsToolOperation<T extends VectorStore = VectorStore>(
	...
	return {
		response: vectorStoreTool,// logWrapper(vectorStoreTool, context),
	};
}
